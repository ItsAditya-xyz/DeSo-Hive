...
function View(props) {
    ...
    useEffect(() => {
        ...
        async function getSinglePostInfo(postHashHex) {
            ...
            const diamondGiven = postResponse.PostFound.PostEntryReaderState.DiamondLevelBestowed;
            ...
            const decryptRequest = {
                content: postExtraData.EncryptedData,
                jwt: jwtToken,
                postHashHex: postHashHex,
    ...
    return (
        <div>
            ...
            {(loggedInPublicKey && !currentJWT && !lackDiamonds) && (
                <div className='container-fluid front-container '>
                    <button
                        className='btn btn-primary btn-sm'
                        onClick={handleJWT}
            ...
            {(decryptedContent && !lackDiamonds && loggedInPublicKey) && (
                ...
                >
                    <div className="d-flex ">
                        <img src={`https://diamondapp.com/api/v0/get-single-profile-picture/${singlePostInfo.ProfileEntryResponse.PublicKeyBase58Check}?fallback=https://diamondapp.com/assets/img/default_profile_pic.png`}
                            alt=''
                            width='40'
                            height='40'
                            style={{ borderRadius: "50%" }}
                        ...
                        <p className="text-lg mx-1"
                            ...
                            }}>{singlePostInfo.ProfileEntryResponse.Username}</p>
